...
fun ConfigurationView(navController: NavController) {
    ...
    Scaffold(
        ...
        ContentConfigurationView(navController)
    }
}

@Composable
fun ContentConfigurationView(navController: NavController) {

    var nombre by remember { mutableStateOf("Jorge Alberto") }
        ...
        )
        {
            ...
            )
            {
                ...
                )
                {
                    ...
                    inputField(label = "Nombre del perfil", value = nombre, type = TypeKeyboard.NORMAL) { nombre = it }
